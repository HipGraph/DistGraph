...
public:
  MultiSourceBFS(distblas::core::SpMat<INDEX_TYPE,VALUE_TYPE> *sp_local_native,
                      distblas::core::SpMat<INDEX_TYPE,VALUE_TYPE> *sp_local_receiver,
                      distblas::core::SpMat<INDEX_TYPE,VALUE_TYPE> *sp_local_sender,
                      distblas::core::SpMat<INDEX_TYPE,VALUE_TYPE> *sparse_local,
...
//      (*(sparse_input->csr_local_data)) =(*(sparse_out->csr_local_data));
  ...
  void update_state_holder( distblas::core::SpMat<INDEX_TYPE,VALUE_TYPE> *sparse_input, DenseMat<INDEX_TYPE,VALUE_TYPE> *dense_mat){
