...
vector<string> distblas::core::perf_counter_keys = {
    ...
    "BFS Frontier","Local SpGEMM","Local SpMM","Local FusedMM","Remote Merge Time","Remote SpGEMM","Sparsity","Communicated Data Store","Communication Data Loading","CSR Conversion","KNN Time"};
