...
//                    alpha, beta,col_major,sync_comm));
    ...
    reader->parallel_write_csr(output_file+"/sparse_embedding.txt",(sparse_out->csr_local_data)->handler.get(),grid.get(), localARows,shared_sparseMat.get()->gRows,localBRows);
