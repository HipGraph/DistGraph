##  DISTFNE: Distributed-Memory Algorithms for Force-Directed Node Embedding
## System Requirements
...
```
To run DISTFNE embedding in distributed memory setup check the job submission batch script [mnist_job.sh](datasets/minst_job.sh)'
