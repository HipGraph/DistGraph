...
srun -n 256 /global/homes/i/isjarana/DistEmbed/build/bin/distembed -input /pscratch/sd/i/isjarana/benchmarking/inputs/arabic-2005/arabic-2005.mtx \
  ...
  -spgemm 1 -iter 3  -input_sparse_file /pscratch/sd/i/isjarana/benchmarking/inputs/arabic-2005/fixed_d/d_128_sp_10/sparse_local.txt\
	-tile_width_fraction 1 -lr 0.02